...
#### Create bucket **_input-bucket-for-polly_**
...
2. At the **Create bucket** page, in the **General configuration** section.
   - In the **AWS Region** field, select **Asia Pacific (Singapore) ap-southeast-1**.
...
![start-create-input-bucket](/images/create-s3/input-bucket.png)

![create-bucket](/images/create-s3/create-bucket.png)

#### Create bucket **_out-bucket-from-polly_**
